...
Namespace CreditGuardClient
    ...
    Public Class ClsWebPageVerificationResult
        ...
        Sub New(ExtendedResultCode As String, ExtendedResultInnerText As String, ExtendedResultOuterText As String, CardToken As String, AuthorizationNumber As String, Expiration As String, OwnerID As UInteger, CardType As EnmCardType?, CardIssuer As EnmCardIssuer?, CardBrand As EnmCardBrand?)
